...
intellisense.annotate(jQuery.fn, {
  ...
  'trigger': function() {
    ...
    ///   <param name="extraParameters" type="">Additional parameters to pass aint to the event handler.</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Execute all handlers and behaviors attached to the matched elements for the given event type.</summary>
  ...
  'width': function() {
    ...
    ///   <param name="value" type="">An integer representing the number of pixels, or an integer aint with an optional unit of measure appended (as a string).</param>
    ///   <returns type="jQuery" />
    /// </signature>
    /// <signature>
    ///   <summary>Set the CSS width of each element in the set of matched elements.</summary>
