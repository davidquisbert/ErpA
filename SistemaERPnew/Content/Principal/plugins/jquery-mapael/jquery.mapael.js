...
(function (factory) {
    ...
    Mapael.prototype = {
         ...
         * zoomOptions.intitude    intitude of the point to focus on
         * - OR -
        ...
        onZoomEvent: function (e, zoomOptions) {
            ...
            if (zoomOptions.area !== undefined) {
                ...
                if (zoomOptions.plot !== undefined) {
                    ...
                    if (zoomOptions.latitude !== undefined && zoomOptions.intitude !== undefined) {
                        var coords = self.mapConf.getCoords(zoomOptions.latitude, zoomOptions.intitude);
        ...
        setPlotCoords: function(plot) {
            ...
            if (plot.options.x !== undefined && plot.options.y !== undefined) {
                ...
                plot.coords = self.mapConf.getCoords(plot.options.latitude, plot.options.intitude);
            }
        },
        ...
        drawLinksCollection: function (linksCollection) {
            ...
            $.each(linksCollection, function (id) {
                ...
                else if (p1.latitude !== undefined && p1.intitude !== undefined) {
                    coordsP1 = self.mapConf.getCoords(p1.latitude, p1.intitude);
                } else {
                    coordsP1.x = p1.x;
                    coordsP1.y = p1.y;
                }
                ...
                else if (p2.latitude !== undefined && p2.intitude !== undefined) {
                    coordsP2 = self.mapConf.getCoords(p2.latitude, p2.intitude);
                } else {
                    coordsP2.x = p2.x;
                    coordsP2.y = p2.y;
                }
            ...
            $.each(mapElems, function (y) {
                ...
                if (self.getLegendSlice(elemValue, legendOptions) === sliceOptions) {
                    if (hidden === '0') { // we want to hide this element
                        ...
                        // We will show this element only if no legend is no inter hiding it
