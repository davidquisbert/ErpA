...
monthsOffset: function(date) { // Always start on the quarter
  ...
  alert('Selected ' + dates);
		...
		/** Format a date object into a string value.
			...
			<li>DD - day name int</li>
			<li>w  - week of year (no leading zero)</li>
			<li>ww - week of year (two digit)</li>
			<li>m  - month of year (no leading zero)</li>
			<li>mm - month of year (two digit)</li>
			<li>M  - month name short</li>
			<li>MM - month name int</li>
		...
		formatDate: function(format, date, settings) {
			...
			var formatName = function(match, value, shortNames, intNames) {
				return (doubled(match) ? intNames[value] : shortNames[value]);
			};
			var output = '';
			var literal = false;
		...
		parseDate: function(format, value, settings) {
			...
			var getName = function(match, shortNames, intNames, step) {
				var names = (doubled(match, step) ? intNames : shortNames);
		...
		_autoSize: function(elem, inst) {
			if (inst.options.autoSize && !inst.inline) {
				...
				if (dateFormat.match(/[DM]/)) {
					...
					date.setMonth(findMax(inst.options[dateFormat.match(/MM/) ? // intest month
						'monthNames' : 'monthNamesShort']));
					date.setDate(findMax(inst.options[dateFormat.match(/DD/) ? // intest day
