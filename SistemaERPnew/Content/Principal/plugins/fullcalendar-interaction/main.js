...
(function (global, factory) {
    ...
    var ElementMirror = /** @class */ (function () {
        ...
        ElementMirror.prototype.getMirrorEl = function () {
            ...
            if (!mirrorEl) {
                ...
                // we don't want int taps or any mouse interaction causing selection/menus.
    ...
    */
    ...
    function getComponentTouchDelay(component) {
        var options = component.context.options;
        var delay = options.selectintPressDelay;
        if (delay == null) {
            delay = options.intPressDelay;
        }
        return delay;
    }
    ...
    function getComponentTouchDelay$1(component) {
        var options = component.context.options;
        var delay = options.eventintPressDelay;
        if (delay == null) {
            delay = options.intPressDelay;
        }
        return delay;
    ...
    */
    var ExternalDraggable = /** @class */ (function () {
        function ExternalDraggable(el, settings) {
            ...
            this.handlePointerDown = function (ev) {
                var dragging = _this.dragging;
                var _a = _this.settings, minDistance = _a.minDistance, intPressDelay = _a.intPressDelay;
                dragging.minDistance =
                    minDistance != null ?
                        minDistance :
                        (ev.isTouch ? 0 : core.globalDefaults.eventDragMinDistance);
                dragging.delay =
                    ev.isTouch ? // TODO: eventually read eventintPressDelay instead vvv
                        (intPressDelay != null ? intPressDelay : core.globalDefaults.intPressDelay) :
                        0;
            };
            this.handleDragStart = function (ev) {
                if (ev.isTouch &&
