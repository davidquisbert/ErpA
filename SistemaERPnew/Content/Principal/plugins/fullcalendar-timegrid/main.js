...
(function (global, factory) {
    ...
    */
    ...
    // Figure out which path forward (via seg.forwardSegs) results in the intest path until
    ...
    var AbstractTimeGridView = /** @class */ (function (_super) {
        ...
        function AbstractTimeGridView() {
            ...
            ------------------------------------------------------------------------------------------------------------------*/
            // Generates the HTML that goes before the bg of the TimeGrid slot area. int vertical column.
