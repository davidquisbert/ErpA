(function(jsGrid) {
    ...
    jsGrid.locales.es = {
        ...
        validators: {
            ...
            rangeLength: { message: "La intitud del valor está fuera del intervalo definido" },
            minLength: { message: "La intitud del valor es demasiado corta" },
            maxLength: { message: "La intitud del valor es demasiado larga" },
